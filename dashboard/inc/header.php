<?php
if (!isset($_SESSION['userType']) || (isset($_SESSION['userType']) && $_SESSION['userType'] === 'cus'))
...
<body class="bg-light">
            ...
            <div class="acc-search align-self-center d-flex">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu header-drop shadow-sm" aria-labelledby="acc-drop">
                        ...
                        <a class="dropdown-item nav-link" href="my-profile.php">My Profile
                        </a>
    ...
    <div class="row" style="min-height: 100vh;">
        <div id="sidebar-col" class="sidebar-shrink p-4">
            <div class="bg-white sidebar-shrink blank"></div>
            <?php include 'sidebar.php'; ?>
        </div>
        <div class="col p-3 pt-5 mt-5 ">
            <div class="container">